        ...
        <div class="user-chip-wrap" @click="showUserMenu = !showUserMenu" v-click-outside="() => showUserMenu = false">
          ...
          <transition name="menu-drop">
            <div v-if="showUserMenu" class="user-menu glass">
              ...
              <!-- Plugin-declared pages (frontend_get_routes) -->
              <template v-if="pluginNavRoutes.length">
                <div class="menu-sep" />
                <button v-for="pr in pluginNavRoutes" :key="pr.path" class="menu-item" @click="showUserMenu = false; $router.push('/x/' + pr.path)">
...
import { pluginNavRoutes } from "@/themes/index";
