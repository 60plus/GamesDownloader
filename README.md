...
- Installed metadata plugins are search sources in their own right: they appear beside the built-in sources in the ROM editor with their own results, and a plugin that supplies artwork is shown above the covers, backgrounds and logos it can provide.
