...
[![Wiki](https://img.shields.io/badge/Docs-Wiki-8A2BE2)](https://gitea.domowy.tech/60plus/GamesDownloader/wiki)
...
> **Get started:** [Installation guide](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Installation) · **Full docs:** [Wiki](https://gitea.domowy.tech/60plus/GamesDownloader/wiki) · **Community:** [Discord](https://discord.gg/Hz8BNNQrMu)
...
| ![Changing disc without leaving the game](docs/screenshots/disc-change.png) | ![Converting a disc set to CHD](docs/screenshots/chd-convert.png) |
| Changing disc without leaving the game | Converting a disc set to CHD, progress in the tray |

---

## Features at a glance

Every area below has a dedicated page in the [Wiki](https://gitea.domowy.tech/60plus/GamesDownloader/wiki) with the full detail.
...
- Full detail: [Library](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Library) · [Collections](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Collections) · [GOG Integration](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/GOG-Integration) · [ROMs & Emulation](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/ROMs-and-Emulation)
...
- **A game that came on four discs is one game.** Press Play and the whole set goes into the emulator at once, so when a title asks for disc two you put it in from the in-game menu or the player and carry on, with no reload and no trip back to the library. Discs that arrive zipped are opened on the way in, an `.m3u` playlist is written for a set that came without one, and the `.sbi` subchannel file that decides whether a protected PAL disc boots at all travels with the discs.
- **Convert discs to CHD without leaving the library.** CHD is the compressed disc format the PlayStation, Saturn, Dreamcast and PC Engine cores read directly, and a button on the ROM page converts a whole title, with progress in the download tray and a stop button. Final Fantasy IX went from 1787 MB to 1484 MB on disk, and the browser tab that plays it from 2781 MB to 1495 MB, which is the difference between a four disc set that runs and one that runs out of memory partway through. Every result is checked against the original before anything is removed, and the library row keeps its saves, artwork and play history.
...
- Full detail: [ROMs & Emulation](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/ROMs-and-Emulation)
...
- Full detail: [Dashboard](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Dashboard)
...
- Full detail: [Scrapers & Metadata](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Scrapers-and-Metadata)
...
- Full detail: [Network & Security](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Network-and-Security) · [Users & Permissions](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Users-and-Permissions) · [Security](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Security)
...
- Full detail: [Downloads & Sharing](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Downloads-and-Torrents)
...
- Full detail: [Email & Notifications](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Email-and-Notifications)
...
- Full detail: [Plugin Development](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Plugin-Development)
...
More on the [Themes](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Themes) page.
...
The [Installation guide](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Installation) has the complete `docker-compose.yml`, a ready-to-edit `.env`, and everything about first boot, updating, and running behind a reverse proxy.

---

## Documentation

The full manual lives in the **[Wiki](https://gitea.domowy.tech/60plus/GamesDownloader/wiki)**:

- [Installation](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Installation) and [Reverse Proxy & HTTPS](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Reverse-Proxy-and-HTTPS)
- [Configuration](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Configuration), [Scrapers & Metadata](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Scrapers-and-Metadata), [Email & Notifications](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Email-and-Notifications), [Network & Security](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Network-and-Security)
- Features: [Dashboard](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Dashboard), [Library](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Library), [Collections](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Collections), [GOG Integration](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/GOG-Integration), [ROMs & Emulation](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/ROMs-and-Emulation), [Downloads & Sharing](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Downloads-and-Torrents), [Users & Permissions](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Users-and-Permissions), [Themes](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Themes)
- [Plugin Development](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Plugin-Development) and the [Plugin Trust Model](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Plugin-Trust-Model)
- [Troubleshooting & FAQ](https://gitea.domowy.tech/60plus/GamesDownloader/wiki/Troubleshooting-and-FAQ)
